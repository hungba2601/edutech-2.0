      ...
      <main className="relative max-w-7xl mx-auto pt-36 sm:pt-44 pb-16 sm:pb-24 px-4 sm:px-6">
        ...
        <section className="mt-16 sm:mt-24 px-2 sm:px-4">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4 sm:gap-6">
            ...
            <button 
              onClick={() => {
                handleResourceClick('8. TRỌN BỘ SGK -SGV KNTT CỦA TẤT CẢ CÁC MÔN TỪ LỚP 1-12', 'https://drive.google.com/drive/folders/1aGJ1VwU-Yzz-h6Qj6nLeQALgNOMAcwY1?usp=sharing');
              }}
              className={`group flex items-center p-4 sm:p-6 border rounded-[1.5rem] sm:rounded-[2rem] transition-all hover:-translate-y-1 relative text-left w-full shadow-lg ${isDarkMode ? 'bg-gradient-to-br from-emerald-950 to-teal-950 border-white/10 shadow-emerald-950/40' : 'bg-gradient-to-br from-emerald-600 to-teal-700 border-white/20 shadow-emerald-900/30'}`}
            >
              <div className="absolute top-3 right-3 z-10 flex flex-col items-end space-y-1">
                <div className="flex items-center space-x-1">
                  <div className="bg-yellow-400 text-slate-900 text-[10px] font-black px-2 py-0.5 rounded-full shadow-lg animate-bounce inline-block">NEW</div>
                ...
                <span className="bg-sky-400/80 backdrop-blur-md text-white text-[8px] sm:text-[9px] font-black px-1.5 py-0.5 rounded-lg shadow-lg border border-white/20 uppercase tracking-tighter">
                  Lượt: {(appCounts['8. TRỌN BỘ SGK -SGV KNTT CỦA TẤT CẢ CÁC MÔN TỪ LỚP 1-12'] || 0).toLocaleString()}
                </span>
              </div>
              <div className={`w-10 h-10 sm:w-14 sm:h-14 rounded-xl sm:rounded-2xl flex items-center justify-center mr-4 sm:mr-5 transition-colors bg-white/20 backdrop-blur-md text-emerald-200 shadow-xl`}>
                <BookOpen size={20} className="sm:w-7 h-7" />
              </div>
              <div className="flex-grow">
                <h4 className="font-black uppercase tracking-wide transition-colors text-xs sm:text-base text-white">8. TRỌN BỘ SGK -SGV KNTT CỦA TẤT CẢ CÁC MÔN TỪ LỚP 1-12</h4>
                <p className="text-[10px] sm:text-sm text-white/80">Kho tài liệu trọn bộ Sách giáo khoa & Sách giáo viên Kết nối tri thức tất cả các môn từ lớp 1 đến lớp 12.</p>
                <div className={`mt-3 inline-flex items-center space-x-2 px-4 py-2 rounded-xl text-xs font-bold uppercase tracking-wider border transition-all group-hover:scale-105 ${isDarkMode ? 'bg-white/20 hover:bg-white hover:text-emerald-900' : 'bg-white/20 hover:bg-white hover:text-emerald-700'} text-white border-white/10`}>
                  <Download size={14} />
                  <span>Truy cập & Tải xuống</span>
                </div>
              </div>
            </button>
          </div>
        ...
        <section className="mt-16 sm:mt-24 px-2 sm:px-4">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4 sm:gap-6">
            ...
            <button 
              onClick={() => {
                handleResourceClick('HƯỚNG DẪN GVCN CẬP NHẬT THÔNG TIN HỌC SINH LÊN CSDL', 'https://youtu.be/OUZIK62qUbQ');
              }}
            ...
            <button 
              onClick={() => {
                handleResourceClick('HƯỚNG DẪN NỘP KHBD LÊN HSĐT', 'https://youtu.be/HNgitjTysWk');
              }}
              className={`group flex items-center p-4 sm:p-6 border rounded-[1.5rem] sm:rounded-[2rem] transition-all hover:-translate-y-1 relative text-left w-full shadow-lg ${isDarkMode ? 'bg-gradient-to-br from-rose-900 to-red-950 border-white/10 shadow-rose-900/20' : 'bg-gradient-to-br from-rose-500 to-red-600 border-white/20 shadow-rose-200'}`}
            >
              <div className="absolute top-3 right-3 z-10 text-right space-y-1">
                <div className="bg-yellow-400 text-slate-900 text-[10px] font-black px-2 py-0.5 rounded-full shadow-lg animate-bounce inline-block">NEW</div>
                <div className="block">
                  <span className="bg-sky-400/80 backdrop-blur-md text-white text-[8px] sm:text-[9px] font-black px-1.5 py-0.5 rounded-lg shadow-lg border border-white/20 uppercase tracking-tighter">
                    Lượt: {(appCounts['HƯỚNG DẪN NỘP KHBD LÊN HSĐT'] || 0).toLocaleString()}
                  </span>
                </div>
              </div>
              <div className={`w-10 h-10 sm:w-14 sm:h-14 rounded-xl sm:rounded-2xl flex items-center justify-center mr-4 sm:mr-5 transition-colors bg-white/20 backdrop-blur-md text-white shadow-xl`}>
                <FileUp size={20} className="sm:w-7 h-7" />
              </div>
              <div className="flex-grow">
                <h4 className={`font-black uppercase tracking-wide transition-colors text-xs sm:text-base text-white`}>HƯỚNG DẪN NỘP KHBD LÊN HSĐT</h4>
                <p className={`text-[10px] sm:text-sm text-white/80`}>Video hướng dẫn nộp kế hoạch bài dạy lên hồ sơ điện tử chi tiết</p>
              </div>
            </button>

            <button 
              onClick={() => {
                handleResourceClick('HƯỚNG DẪN GVCN ĐỔI MK HS TRÊN K12', 'https://youtu.be/mgm3g35kQtk');
              }}
              className={`group flex items-center p-4 sm:p-6 border rounded-[1.5rem] sm:rounded-[2rem] transition-all hover:-translate-y-1 relative text-left w-full shadow-lg ${isDarkMode ? 'bg-gradient-to-br from-amber-900 to-orange-950 border-white/10 shadow-amber-900/20' : 'bg-gradient-to-br from-amber-500 to-orange-600 border-white/20 shadow-amber-200'}`}
            >
              <div className="absolute top-3 right-3 z-10 text-right space-y-1">
                <div className="bg-yellow-400 text-slate-900 text-[10px] font-black px-2 py-0.5 rounded-full shadow-lg animate-bounce inline-block">NEW</div>
                <div className="block">
                  <span className="bg-sky-400/80 backdrop-blur-md text-white text-[8px] sm:text-[9px] font-black px-1.5 py-0.5 rounded-lg shadow-lg border border-white/20 uppercase tracking-tighter">
                    Lượt: {(appCounts['HƯỚNG DẪN GVCN ĐỔI MK HS TRÊN K12'] || 0).toLocaleString()}
                  </span>
                </div>
              </div>
              <div className={`w-10 h-10 sm:w-14 sm:h-14 rounded-xl sm:rounded-2xl flex items-center justify-center mr-4 sm:mr-5 transition-colors bg-white/20 backdrop-blur-md text-white shadow-xl`}>
              ...
              <div className="flex-grow">
                <h4 className={`font-black uppercase tracking-wide transition-colors text-xs sm:text-base text-white`}>HƯỚNG DẪN GVCN ĐỔI MK HS TRÊN K12</h4>
                <p className={`text-[10px] sm:text-sm text-white/80`}>Video hướng dẫn giáo viên chủ nhiệm đổi mật khẩu học sinh trên K12Online</p>
              </div>
            </button>
          </div>
        </section>
